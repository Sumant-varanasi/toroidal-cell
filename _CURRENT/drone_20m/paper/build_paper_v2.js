...
body.push(...tbl(
  "Independent COMSOL Ray-Optics cross-validation: chief-ray deviation from the exact tracer over the complete folded path, and COMSOL's own re-entrance (exit-vertex distance from the entrance point).",
  ["design", "bounces", "RMS [µm]", "worst [µm]", "median [µm]", "re-exit [mm]"],
  [
    ["ceiling 29.0 m", "204", "1.29", "3.11", "1.00", "0.010"],
    ["tri-gas 25.7 m", "176", "3.81", "9.09", "2.93", "0.009"],
    ["H2-opt. 23.8 m", "176", "3.60", "8.96", "2.25", "0.010"],
    ["27 m (Ø160)", "228", "4.24", "10.16", "2.67", "0.010"],
    ["compact 20.7 m", "204", "2.80", "6.88", "1.79", "0.009"],
    ["standard-tier 22.3 m", "182", "1.33", "2.94", "1.01", "0.010"],
    ["two-inch 19.0 m", "152", "8.66", "19.71", "5.68", "0.018"],
    ["sparse 15.3 m", "112", "3.26", "7.82", "2.19", "0.009"],
    ["mini 9.1 m (½″)", "98", "1.26", "3.01", "0.80", "0.008"],
  ],
  [2150, 1050, 1100, 1100, 1200, 1200]));
